...
\033[1;92mAuthor \033[1;93m: Ferdous Hasan

\033[1;92mFb \033[1;93m: Ferdous Hasan
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://youtube.com/channel/UCGB3WNHaS8KX5TmoGQTTtRQ')
...
#-----------------------------
    ...
    print '   Welcome Dear: ' FERDOUS HASAN
...
def crack():
    ...
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks Ferdous Hasan.& Also Mamun Miah
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks Ferdous Hasan
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;32m[FERDOUS-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                print '\x1b[1;31m[FERDOUS-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;31m[FERDOUS-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[FERDOUS-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks Ferdous Hasan.& Also Mamun Miah
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Ferdous Hasan & Mamun Miah
...
#Thanks Ferdous Hasan & Mamun Miah
